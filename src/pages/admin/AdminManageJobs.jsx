    ...
    <div className="min-h-screen pt-20 px-4 pb-12">
      <div className="max-w-6xl mx-auto">
        <div className="py-8">
          ...
          <p className="text-gray-400 mt-1">{filtered.length} of {jobs.length} jobs</p>
        </div>
            ...
            {filtered.map(job => (
              <div key={job._id} className="card flex items-start justify-between gap-4 flex-wrap hover:scale-[1.005] transition-all animate-slide-up">
                <div className="flex items-start gap-4 flex-1 min-w-0">
                  <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-primary-600/30 to-accent-600/30 border border-primary-500/20 flex items-center justify-center font-bold flex-shrink-0 overflow-hidden">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-3 mt-1.5 text-xs text-gray-500">
                      ...
                      {job.employer && <span className="text-gray-600">by {job.employer.name}</span>}
                    </div>
                  </div>
                </div>
