            ...
            <div className="flex-1 min-w-0">
              {editing ? (
                ...
                <>
                  ...
                  <p className="text-gray-400 mt-1">{profile.bio || 'No bio added'}</p>
          ...
          {editing ? (
            ...
            <div className="flex flex-wrap gap-2">
              {profile.skills?.length > 0
                ? profile.skills.map(s => <span key={s} className="px-3 py-1.5 bg-gray-800 text-gray-300 text-sm rounded-lg border border-gray-700">{s}</span>)
        ...
        <div className="card">
          ...
          {profile.resume ? (
            <a href={profile.resume} target="_blank" rel="noreferrer"
              className="flex items-center gap-3 p-4 bg-gray-800/50 rounded-xl border border-gray-700 hover:border-primary-500/50 transition-all group">
              <div className="w-10 h-10 bg-red-500/20 rounded-lg flex items-center justify-center">
                <span className="text-red-400 text-xs font-bold">PDF</span>
              </div>
              <div>
                <p className="text-white text-sm font-medium group-hover:text-primary-400 transition-colors">View Resume</p>
                <p className="text-gray-500 text-xs">Click to open</p>
              </div>
            </a>
          ) : (
